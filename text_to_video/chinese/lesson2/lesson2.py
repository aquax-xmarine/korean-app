...
COLS = 5
ROWS = (len(VOCABULARY) + COLS - 1) // COLS  # ceiling division
...
GRID_H = ROWS * CARD_H + (ROWS - 1) * GAP_Y  # ← now dynamic

GRID_X = (W - GRID_W) // 2
GRID_Y = 90 + (H - 90 - 72 - GRID_H) // 2   # ← centers correctly for any row count
